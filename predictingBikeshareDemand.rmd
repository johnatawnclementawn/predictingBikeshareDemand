...
```{r origin_map, fig.width=12, fig.height=6}
ridesStartPoints <- rides %>%
...
ggplot()+
  ...
  labs(title="Bike share trips per hr by station. Washington DC, September-October, 2021") +
  mapTheme()
```
